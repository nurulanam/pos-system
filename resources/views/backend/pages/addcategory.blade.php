    ...
    <div class="container-fluid px-4">
        ...
        <div class="row align-items-center">
                    ...
                    <div class="card-body">
                        <form action="{{route('category.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-8">
                                    <textarea type="text" name="category_description" class="form-control" placeholder="Category Description" rows="10"></textarea>
                                </div>
                            </div>
                            <div class="form-group row mb-3">
                                <div class="col-md-4">
            ...
            <div class="col-md-4 mt-3">
                ...
                @endif
                <img src="https://via.placeholder.com/300" id="previewImg" class="img-thumbnail img-fluid">
                <script>
